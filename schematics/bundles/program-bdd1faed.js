...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('19.1.0-next.0+sha-dca1483-with-local-changes'));
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `19.1.0-next.0+sha-dca1483-with-local-changes` usually means that core is at head so it supports
